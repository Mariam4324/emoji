...
let Boxcollection = document.querySelectorAll(".finder__box");

let Boxtitle = document.querySelector(".finder__emoji__name");
...
// title.textContent = ${recipies.name};
// container.append(title);

// let list = document.createElement("ul");
// container.append(list);

// let ingridientsEl = recipies.ingridient;
// ingridientsEl.forEach((ingridient) => {
